...
/**
 * Legacy Dashboard Data Hook
 * Maintains compatibility with existing Dashboard.tsx
 */
export const useLegacyDashboardData = () => {
  ...
  const generateMockData = (): LegacyDashboardData => {
