        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li className="text-gray-400">Financial Planning</li>
              <li className="text-gray-400">Design Services</li>
              <li className="text-gray-400">Legal Advisory</li>
            </ul>
          </div>
          ...
          <div>
            ...
            <div className="space-y-3">
              <div className="flex items-center">
                ...
                <span className="text-gray-400">contact@professionalservices.com</span>
              </div>
              <div className="flex items-center">
              ...
              <div className="flex items-center">
                ...
                <span className="text-gray-400">123 Business Ave, Professional District</span>
              </div>
            </div>
          </div>
        </div>
